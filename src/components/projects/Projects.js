  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-14">
        ...
        <ProjectsCardThree
          title="Connect Now"
          des=" Connect Now is a modern web-based messaging platform that connects users through instant text, image, audio, and file exchanges. The application includes secure login and registration processes, supports engaging group chats, and utilizes strong encryption to ensure all communications are private and secure."
          src={projectThree}
        />
        <ProjectsCardFour
          title="Shooting Game"
