...
import { FaMobile, FaGlobe, FaGamepad } from "react-icons/fa";
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-20">
        ...
        <Card
          ...
          des="I create immersive, engaging games with a focus on seamless mechanics, captivating visuals, and memorable player experiences."
          icon={<FaGamepad />}
        />
        <Card
          title="3D Animation"
